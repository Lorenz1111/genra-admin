...
export default function AuthorDashboard() {
  ...
  return (
    // SD MAGIC 1: width 100% at overflow hidden ang main container para HINDI masira ang page sa mobile
    <Box sx={{ width: '100%', maxWidth: '1200px', pb: { xs: 4, md: 8 }, px: { xs: 2, md: 0 }, overflow: 'hidden' }}>
      ...
      <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, justifyContent: 'space-between', alignItems: { xs: 'flex-start', md: 'center' }, mb: { xs: 3, md: 5 }, gap: 3 }}>
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
          {/* SD MAGIC 2: Responsive Avatar (Liliit sa mobile) */}
          ...
          <Box>
            {/* SD MAGIC 3: Responsive Text (Liliit sa mobile) */}
        ...
        {/* SD MAGIC 4: Magpapanpantay ang buttons kapag mobile */}
      ...
      {/* --- STATS CARDS --- */}
      {/* SD MAGIC 5: Responsive Grid na mag-aayos sa mobile */}
      ...
      {/* SD MAGIC 6: width 100% ang Paper para hindi bumutas sa screen, DataGrid ang magkaka-scrollbar sa loob! */}
      <Paper 
        elevation={0} 
        sx={{ 
          height: { xs: 500, md: 650 }, // Mas maikli nang konti sa mobile para di masyadong scroll pababa
          width: '100%', 
          borderRadius: 3, 
      ...
      >
        <DataGrid
          ...
          sx={{
            border: 'none',
            // Piliting mag-scroll nang horizontal sa loob ng grid
